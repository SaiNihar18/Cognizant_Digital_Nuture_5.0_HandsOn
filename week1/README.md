...
This folder contains the implementations for the mandatory hands-on exercises for the **Design Patterns and Principles** module. These implementations focus on clean, fundamental, and well-documented Java code to facilitate learning and core understanding.
...
cd week1/SingletonPatternExample/src
...
cd week1/FactoryMethodPatternExample/src
